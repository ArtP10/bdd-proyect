...
DROP TABLE IF EXISTS pue_tras CASCADE; -- Relación circular con detalle_reserva
DROP TABLE IF EXISTS resena CASCADE;
DROP TABLE IF EXISTS reclamo CASCADE;
DROP TABLE IF EXISTS res_est CASCADE; -- Histórico de estados de reserva
...
DROP TABLE IF EXISTS estado CASCADE; -- Estados generales
...
DROP TABLE IF EXISTS lugar CASCADE; -- Ojo: Tiene auto-referencia
