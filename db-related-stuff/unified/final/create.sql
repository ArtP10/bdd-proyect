...
CREATE TABLE privilegio(
    ...
    pri_nombre varchar(50) NOT NULL UNIQUE,
...
CREATE TABLE nacionalidad(
    ...
    nac_nombre varchar(50) UNIQUE NOT NULL,
    nac_descripcion VARCHAR(100)
);

CREATE TABLE viajero(
    via_codigo SERIAL PRIMARY KEY,
    via_prim_nombre varchar(50) NOT NULL,
    via_seg_nombre varchar(50),
    via_prim_apellido varchar(50) NOT NULL,
    via_seg_apellido varchar(50),
...
CREATE TABLE servicio(
    ...
    ser_tipo varchar(50) NOT NULL DEFAULT 'Practico',
...
CREATE TABLE paquete_turistico(
    ...
    paq_tur_descripcion varchar(50),
...
CREATE TABLE ruta(
    ...
    rut_descripcion varchar(50) NOT NULL DEFAULT 'Practico',
