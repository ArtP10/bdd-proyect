  ...
  <div class="dashboard-layout">
    ...
    <main class="main-content">
      ...
      <div class="tabs-container" v-if="activeMenuItem === 'Gestion'">
        <div class="tabs">
          <button class="tab" :class="{ active: activeTab === 'Datos personales' }"
            @click="activeTab = 'Datos personales'">Datos personales</button>
          <button class="tab" :class="{ active: activeTab === 'Mis viajeros' }" @click="activeTab = 'Mis viajeros'">Mis
            viajeros</button>
          <button class="tab" :class="{ active: activeTab === 'Seguridad' }"
            @click="activeTab = 'Seguridad'">Seguridad</button>
        </div>
      </div>
      ...
      <div class="content-body">
        ...
        <div v-else-if="activeMenuItem === 'Deseos'">
          <Wishlist :user-id="userInfo.user_id" />
        </div>
